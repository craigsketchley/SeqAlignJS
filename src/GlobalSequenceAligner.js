...
// TODO: Could use a single sequence aligner and use pseudo-enum type like:
var AlignmentType = {
    GLOBAL : "GLOBAL",
    LOCAL  : "LOCAL"
};
 ...
 */
var GlobalSequenceAligner = function(options) {
    if (!defined(options)) {
 ...
 * @return {String}
 */
GlobalSequenceAligner.prototype.align = function(seq1, seq2) {
...
module.exports = GlobalSequenceAligner;
